...
public class UIManager {
    ...
    private void setupSpinner(Spinner<Double> spinner, double min, double max, 
    ...
    public void updateSpinnersFromTransform(Transform transform, Spinner<Double> translateXField, 
                                          Spinner<Double> translateYField, Spinner<Double> translateZField,
                                          Spinner<Double> rotateXField, Spinner<Double> rotateYField,
                                          Spinner<Double> rotateZField, Spinner<Double> scaleXField,
                                          Spinner<Double> scaleYField, Spinner<Double> scaleZField) {
    ...
    private float getSpinnerValue(Spinner<Double> spinner) {
        return spinner != null && spinner.getValue() != null ? 
               spinner.getValue().floatValue() : 0.0f;
    }
